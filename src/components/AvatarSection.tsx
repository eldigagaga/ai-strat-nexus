...
const AvatarSection = () => (
  <section id="avatar" className="py-20 bg-secondary/30">
    <div className="container">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-sm font-semibold text-accent uppercase tracking-wider mb-2">Interaktivní AI</p>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Zeptej se vyučujícího</h2>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="aspect-square max-w-md mx-auto rounded-2xl overflow-hidden border border-accent/20 shadow-card">
            <img src={avatarImg} alt="AI Avatar vyučujícího" className="w-full h-full object-cover" />
          </div>
